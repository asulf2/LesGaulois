...
public class Druide {
	...
	public Druide(String nom, int effetPotionMin, int effetPotionMax) {
		...
		parler("Bonjour, je suis le Druide " + nom + " et ma potion peut "
				+ "aller d'une force " + effetPotionMin + " à " + effetPotionMax +".");
	...
	public void preparerPotion() {
		...
		System.out.println("Le druide prépare une potion de force...");
		if(forcePotion > 7) {
			System.out.println("J'ai préparé une super potion de force de "+ forcePotion + " .");
		}else{
